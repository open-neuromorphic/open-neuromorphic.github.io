...
accelerators (but not only): the multilply-and-accumulate (MAC) operation.  Why do
we care about MACs?
...
does not directly support sparsity in hardware, contrarily to what I believed.
