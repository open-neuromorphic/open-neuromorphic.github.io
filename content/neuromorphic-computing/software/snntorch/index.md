...
description: >-
  Focuses on gradient-based training of SNNs, based on PyTorch for GPU
  acceleration and gradient computation.
logo: snntorch.png
...
url: /neuromorphic-computing/software/snn-frameworks/snntorch/
---
