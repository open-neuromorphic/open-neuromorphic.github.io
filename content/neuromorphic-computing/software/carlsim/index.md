...
description: >-
  GPU-accelerated library for simulating large-scale spiking neural network
  (SNN) models with high biologically realistic synaptic dynamics.
...
url: /neuromorphic-computing/software/snn-frameworks/carlsim/
---
