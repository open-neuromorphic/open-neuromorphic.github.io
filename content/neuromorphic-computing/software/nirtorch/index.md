...
description: >-
  A PyTorch extension for the Neuromorphic Intermediate Representation (NIR),
  enabling seamless conversion of PyTorch-based SNN models to and from NIR.
logo: nir-logo.png
...
url: /neuromorphic-computing/software/snn-frameworks/nirtorch/
---
