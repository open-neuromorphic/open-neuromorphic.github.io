...
description: >-
  Exploits bio-inspired neural components, sparse and event-driven, expands
  PyTorch with primitives for bio-inspired neural components.
logo: norse.png
...
url: /neuromorphic-computing/software/snn-frameworks/norse/
---
