...
description: >-
  AEStream is a tool for transmitting event data efficiently, supporting diverse
  inputs/outputs and integrating with Python and C++ libraries.
logo: aestream.png
...
draft: false
category: data-tool
url: /neuromorphic-computing/software/data-tools/aestream/
---
