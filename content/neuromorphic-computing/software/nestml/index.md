...
description: >-
  A domain-specific language and code generation toolchain for neuron and
  synapse models in spiking neural network simulation
logo: nestml.png
...
category: data-tool
url: /neuromorphic-computing/software/data-tools/nestml/
---
