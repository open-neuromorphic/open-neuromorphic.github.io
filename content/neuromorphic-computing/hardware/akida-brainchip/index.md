...
product:
  announced_date: 2022-10-01T00:00:00.000Z
  ...
  power: ~30 mW
  release_year: 2022
  release_date: 2022-10-01T00:00:00.000Z
  software: MetaTF
  status:
    announced: true
    released: true
...
product_name: Akida
summary: >-
  BrainChip's Akida is an ultra-low-power neuromorphic processor inspired by the
  brain's neural architecture. It accelerates complex AI at the edge through
  event-based processing, on-chip learning abilities, and support for advanced
  neural networks like CNNs, RNNs & custom Temporal Event-based Nets.
